...
class DivisionController {
    ...
    def save() {
        ...
        flash.message = divisionInstance.DIV_NAME+" বিভাগ তৈরী করা হয়েছে"
    ...
    def show(Long id) {
        ...
        if (!divisionInstance) {
            flash.message = divisionInstance.DIV_NAME+" বিভাগ দেখানো হয়েছে"
    ...
    def update(Long id, Long version) {
        ...
        flash.message = divisionInstance.DIV_NAME+" বিভাগ সম্পাদন করা  হয়েছে"
        redirect(action: "show", id: divisionInstance.id)
    }
    ...
    def delete(Long id) {
        ...
        try {
            ...
            flash.message = divisionInstance.DIV_NAME+" বিভাগ মুছে  ফেলা হয়েছে"
            redirect(action: "list")
        }
