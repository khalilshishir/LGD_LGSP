...
<html>
	...
	<body>
		...
		<div id="create-traineeCategory" class="content scaffold-create" role="main">
			...
			<g:hasErrors bean="${traineeCategoryInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${traineeCategoryInstance}" var="error">
