...
<html>
	...
	<body>
		%{--<a href="#edit-payscale_Detail" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-payscale_Detail" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${payscale_DetailInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${payscale_DetailInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${payscale_DetailInstance?.version}" />
				<fieldset class="form">
