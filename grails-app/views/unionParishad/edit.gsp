...
<html>
	...
	<body>
		%{--<a href="#edit-unionParishad" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
        ...
        <div id="edit-unionParishad" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${unionParishadInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${unionParishadInstance}" var="error">
				...
				<g:hiddenField name="version" value="${unionParishadInstance?.version}" />
				<fieldset class="form">
