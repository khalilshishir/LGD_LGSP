...
<html>
	...
	<body>
		%{--<a href="#edit-ASSET_MAJOR_CATEGORY" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
    ...
    <p align="right" style="color:#666; font-size: 11px; padding-right: 5px; margin-top: 10px;">
		...
		<div id="edit-ASSET_MAJOR_CATEGORY" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${ASSET_MAJOR_CATEGORYInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${ASSET_MAJOR_CATEGORYInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${ASSET_MAJOR_CATEGORYInstance?.version}" />
				<fieldset class="form">
