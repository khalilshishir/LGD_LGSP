...
<html>
	...
	<body>
		%{--<a href="#edit-payscale" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-payscale" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${payscaleInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${payscaleInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${payscaleInstance?.version}" />
				<fieldset class="form">
