...
<html>
    ...
    <p align="right" style="color:#666; font-size: 11px; padding-right: 5px; margin-top: 10px;">
		...
		<div id="edit-pmuProcPlan" class="content scaffold-edit" role="main">
            <div class="panel panel-info">
                <div class="panel-heading">
                    ...
                    <g:hasErrors bean="${pmuProcPlanInstance}">
                        <ul class="errors" role="alert">
                            <g:eachError bean="${pmuProcPlanInstance}" var="error">
                ...
                <div class="panel-body">
                    ...
                    <g:form method="post" >
                        ...
                        <g:hiddenField name="version" value="${pmuProcPlanInstance?.version}" />
                        <fieldset class="form">
