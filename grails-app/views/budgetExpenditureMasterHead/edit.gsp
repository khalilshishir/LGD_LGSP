...
<div id="edit-budgetExpenditureMasterHead" class="content scaffold-edit" role="main">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            ...
            <g:hasErrors bean="${budgetExpenditureMasterHeadInstance}">
                <ul class="errors" role="alert">
                    <g:eachError bean="${budgetExpenditureMasterHeadInstance}" var="error">
        ...
        <div class="panel-body">
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${budgetExpenditureMasterHeadInstance?.version}" />
                <fieldset class="form">
