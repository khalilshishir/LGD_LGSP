...
<html>
	...
	<body>
		...
		<div id="edit-trainingStatus" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${trainingStatusInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${trainingStatusInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${trainingStatusInstance?.version}" />
				<fieldset class="form">
