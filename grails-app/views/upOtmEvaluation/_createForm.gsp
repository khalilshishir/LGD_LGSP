...
<div class="col-xs-6">
    <div class="form-group">
        ...
        <g:select id="UP_PROC_MASTER" name="UP_PROC_MASTER.id" from="${upProcMasterList}" optionKey="id" optionValue="SCHEME_INFO" noSelection="${['':'Select One...']}" required="" value="${upOtmEvaluationInstance?.UP_PROC_MASTER?.id}" onchange="setValueOnProcurementChange(this.value)" class="form-control"/>
    </div>
</div>
