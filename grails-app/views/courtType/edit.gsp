...
<html>
	...
	<body>
		%{--<a href="#edit-courtType" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
    ...
    <p align="right" style="color:#666; font-size: 11px; padding-right: 5px; margin-top: 10px;">
		...
		<div id="edit-courtType" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${courtTypeInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${courtTypeInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${courtTypeInstance?.version}" />
				<fieldset class="form">
