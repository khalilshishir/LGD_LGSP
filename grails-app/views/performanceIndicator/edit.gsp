...
<html>
	<head>
		...
		<g:set var="entityName" value="${message(code: 'performanceIndicator.label', default: 'PerformanceIndicator')}" />
		<title><g:message code="default.edit.label" args="[entityName]" /></title>
	</head>
	<body>
		%{--<a href="#edit-performanceIndicator" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
		...
		<div id="edit-performanceIndicator" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${performanceIndicatorInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${performanceIndicatorInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${performanceIndicatorInstance?.version}" />
				<fieldset class="form">
