...
<html>
	...
	<body>
		%{--<a href="#create-monthly_Salary_Process" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-monthly_Salary_Process" class="content scaffold-create" role="main">
