...
<html>
	...
	<body>
		%{--<a href="#edit-monthly_Salary_Process" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-monthly_Salary_Process" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${monthly_Salary_ProcessInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${monthly_Salary_ProcessInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${monthly_Salary_ProcessInstance?.version}" />
				<fieldset class="form">
