...
<html>
	...
	<body>
		%{--<a href="#edit-access_Control_Menu" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
		...
		%{--<div id="edit-access_Control_Menu" class="content scaffold-edit" role="main">--}%
			%{--<h1><g:message code="default.edit.label" args="[entityName]" /></h1>--}%
			<g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
			</g:if>
			<g:hasErrors bean="${access_Control_MenuInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${access_Control_MenuInstance}" var="error">
				...
				<g:hiddenField name="version" value="${access_Control_MenuInstance?.version}" />
				<fieldset class="form">
