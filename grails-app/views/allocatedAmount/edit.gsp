...
<html>
    ...
    <p align="right" style="color:#666; font-size: 11px; padding-right: 5px; margin-top: 10px;">
		...
		<div id="edit-allocatedAmount" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${allocatedAmountInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${allocatedAmountInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${allocatedAmountInstance?.version}" />
				<fieldset class="form">
