...
<html>
	...
	<body>
		%{--<a href="#edit-lgedOffice" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
    ...
    <p align="right" style="color:#666; font-size: 11px; padding-right: 5px; margin-top: 10px;">
		...
		<div id="edit-lgedOffice" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${lgedOfficeInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${lgedOfficeInstance}" var="error">
			...
			<g:form method="post" >
				<g:hiddenField name="id" value="${lgedOfficeInstance?.id}" />
				<g:hiddenField name="version" value="${lgedOfficeInstance?.version}" />
				<fieldset class="form">
