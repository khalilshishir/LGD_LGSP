...
<html>
	...
	<body>
		...
		<div id="edit-trainingParticipantsAbsentReason" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${trainingParticipantsAbsentReasonInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${trainingParticipantsAbsentReasonInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${trainingParticipantsAbsentReasonInstance?.version}" />
				<fieldset class="form">
