...
<html>
	...
	<body>
		%{--<a href="#create-lookup" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
    ...
    <p align="right" style="color:#666; font-size: 11px; padding-right: 5px; margin-top: 10px;">
		...
		<div id="create-lookup" class="content scaffold-create" role="main">
			...
			<g:hasErrors bean="${lookupInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${lookupInstance}" var="error">
