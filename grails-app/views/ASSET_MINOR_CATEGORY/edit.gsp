...
<html>
	...
	<body>
		%{--<a href="#edit-ASSET_MINOR_CATEGORY" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
		...
		<div id="edit-ASSET_MINOR_CATEGORY" class="content scaffold-edit" role="main">
			%{--<h1><g:message code="default.edit.label" args="[entityName]" /></h1>--}%
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title"><g:message code="Edit Minor Asset" args="[entityName]" /></h3>
                </div>
            ...
            <g:if test="${flash.message}">
                ...
                <g:hasErrors bean="${ASSET_MINOR_CATEGORYInstance}">
                <ul class="errors" role="alert">
                    <g:eachError bean="${ASSET_MINOR_CATEGORYInstance}" var="error">
                ...
                <div class="panel-body">
                    <g:form method="post" >
                        ...
                        <g:hiddenField name="version" value="${ASSET_MINOR_CATEGORYInstance?.version}" />
                        <fieldset class="form">
