...
<html>
	...
	<body>
		%{--<a href="#edit-upInspection" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
    ...
    <div id="edit-ward" class="content scaffold-edit" role="main">
        <div class="panel panel-info">
            <div class="panel-heading">
                ...
                <g:hasErrors bean="${upInspectionInstance}">
                    <ul class="errors" role="alert">
                        <g:eachError bean="${upInspectionInstance}" var="error">
            ...
            <div class="panel-body">
                ...
                <g:form method="post" >
                    ...
                    <g:hiddenField name="version" value="${upInspectionInstance?.version}" />
                    <fieldset class="form">
