...
<html>
	...
	<body>
		%{--<a href="#create-attendance_Info" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-attendance_Info" class="content scaffold-create" role="main">
