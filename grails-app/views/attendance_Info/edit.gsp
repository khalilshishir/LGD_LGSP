...
<html>
	...
	<body>
		%{--<a href="#edit-attendance_Info" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-attendance_Info" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${attendance_InfoInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${attendance_InfoInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${attendance_InfoInstance?.version}" />
				<fieldset class="form">
