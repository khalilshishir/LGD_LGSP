...
<html>
	...
	<body>
		...
		<div id="edit-trainingInformation" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${trainingInformationInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${trainingInformationInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${trainingInformationInstance?.version}" />
				<fieldset class="form">
