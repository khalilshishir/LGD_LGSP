...
<html>
	...
	<body>
		%{--<a href="#edit-attendance_Process" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-attendance_Process" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${attendance_ProcessInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${attendance_ProcessInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${attendance_ProcessInstance?.version}" />
				<fieldset class="form">
