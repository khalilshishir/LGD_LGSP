...
<html>
	...
	<body>
		%{--<a href="#edit-upManagementLetter" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
    ...
    <p align="right" style="color:#666; font-size: 11px; padding-right: 5px; margin-top: 10px;">
		...
		<div id="edit-upManagementLetter" class="content scaffold-edit" role="main">
            <div class="panel panel-info">
                <div class="panel-heading">
                    ...
                    <g:hasErrors bean="${upManagementLetterInstance}">
                        <ul class="errors" role="alert">
                            <g:eachError bean="${upManagementLetterInstance}" var="error">
                ...
                <div class="panel-body">
                    ...
                    <g:form method="post" >
                        ...
                        <g:hiddenField name="version" value="${upManagementLetterInstance?.version}" />
                        <fieldset class="form">
