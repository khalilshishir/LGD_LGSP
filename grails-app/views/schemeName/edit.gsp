...
<html>
	<head>
		...
		<g:set var="entityName" value="${message(code: 'schemeName.label', default: 'SchemeName')}" />
		<title><g:message code="default.edit.label" args="[entityName]" /></title>
	</head>
	<body>
		%{--<a href="#edit-schemeName" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
        ...
        <div id="edit-schemeName" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${schemeNameInstance?.version}" />
				<fieldset class="form">
