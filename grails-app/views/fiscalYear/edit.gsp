...
<html>
	...
	<body>
		...
		<div id="edit-fiscalYear" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${fiscalYearInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${fiscalYearInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${fiscalYearInstance?.version}" />
				<fieldset class="form">
