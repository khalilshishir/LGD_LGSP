...
<html>
	<head>
		...
		<g:set var="entityName" value="${message(code: 'ASSET_BOOK.label', default: 'Asset Book')}" />
		...
		<div id="list-ASSET_BOOK" class="content scaffold-list" role="main">
            ...
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title"><g:message code="Asset Book list" args="[entityName]" /></h3>
                </div>
            </div>
                ...
                <div class="modal-dialog" style="width: 60%;">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Asset Movement History</h4>
                        </div>

                        <div class="modal-body">
                            %{--<g:render template="addWBS"/>--}%
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10" style="overflow: scroll;">
                                    <table  id="data-list"  class="dataListTable table table-bordered table-striped table-hover table-condensed dataTable">
			...
			<table id="example" class="dataListTable table table-bordered table-striped table-hover table-condensed">
				...
				<g:each in="${ASSET_BOOKInstanceList}" status="i" var="ASSET_BOOKInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><a href="#myModal" id="ASSET_NUMBER" onclick="hye(${ASSET_BOOKInstance.id})" value="${ASSET_BOOKInstance.id}" data-toggle="modal">${fieldValue(bean: ASSET_BOOKInstance, field: "ASSET_NUMBER")}</a></td>
                        ...
                        <td><a class="btn btn-info" href="#myModal" id="ASSET_NUMBER" onclick="hye(${ASSET_BOOKInstance.id})" value="${ASSET_BOOKInstance.id}" data-toggle="modal">Click</a></td>
...
//                    alert(asset_id);
                    ...
                    $.ajax({
                        url: base + "/ASSET_BOOK/assetMovement",
                        type: "POST",
                        data: "id=" + asset_id,
                        //dataType: "json",
                        beforeSend: function () {
