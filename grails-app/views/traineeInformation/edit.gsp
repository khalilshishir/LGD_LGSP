...
<html>
	...
	<body>
		...
		<div id="edit-traineeInformation" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${traineeInformationInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${traineeInformationInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${traineeInformationInstance?.version}" />
				<fieldset class="form">
