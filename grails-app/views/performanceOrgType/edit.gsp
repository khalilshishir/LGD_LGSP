...
<html>
	...
	<body>
		%{--<a href="#edit-performanceOrgType" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
        ...
        <div id="edit-performanceOrgType" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${performanceOrgTypeInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${performanceOrgTypeInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${performanceOrgTypeInstance?.version}" />
				<fieldset class="form">
