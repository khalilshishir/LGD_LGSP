...
<div id="edit-pmuProcurPlan" class="content scaffold-edit" role="main">
    ...
    <div class="panel panel-info">
        ...
        <g:hasErrors bean="${pmuProcurPlanInstance}">
            <ul class="errors" role="alert">
                <g:eachError bean="${pmuProcurPlanInstance}" var="error">
        ...
        <g:form method="post">
            ...
            <g:hiddenField name="version" value="${pmuProcurPlanInstance?.version}"/>
            <fieldset class="form">
