    ...
    <div class="row">
                   ...
                   <div class="col-sm-10">
                       ...
                       <tr>
                           ...
                           <tbody>
                           <g:each in="${PmuProcurPlanWbsInstanceList}" status="i" var="wbs">
                           <tr>
                               ...
                               <td class="actions ">
                                   <div class="btn-group">
                                       <a class="btn btn-warning"
                                          href="${g.createLink(controller: 'pmuProcurPlan', action: 'showone', params: [id: wbs?.id])}"
...
//                            alert(data.obj.assign_person);
         ...
         // $('#example').prepend("<tr><td>"+data.obj.assign_person+"</td><td>" + data.obj.test_details +"</td><td>" + data.obj.test_name +"</td><td>" + data.obj.type +"</td><td><a href='${g.createLink(controller: 'pmuProcurPlan',action: 'showtwo',params:[wid:data?.obj?.id])}' class='btn btn-warning'><i class='glyphicon glyphicon-pencil'></i></a></td></tr>");
...
//                                  $('#example').prepend("<tr><td>"+data.obj.assign_person+"</td><td>" + data.obj.test_details +"</td><td>" + data.obj.test_name +"</td><td>" + data.obj.type +"</td><td><a href='#' class='btn btn-warning'><i class='glyphicon glyphicon-pencil'></i></a></td></tr>");
