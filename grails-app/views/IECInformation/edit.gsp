...
<html>
	...
	<body>
		...
		<div id="edit-IECInformation" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${IECInformationInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${IECInformationInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${IECInformationInstance?.version}" />
				<fieldset class="form">
