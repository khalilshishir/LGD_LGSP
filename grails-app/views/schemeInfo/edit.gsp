...
<html>
	...
	<body>
		%{--<a href="#edit-schemeInfo" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
    ...
    <p align="right" style="color:#666; font-size: 11px; padding-right: 5px; margin-top: 10px;">
		...
		<div id="edit-schemeInfo" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${schemeInfoInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${schemeInfoInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${schemeInfoInstance?.version}" />
				<fieldset class="form">
