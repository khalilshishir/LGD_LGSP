    ...
    <div id="edit-division" class="content scaffold-edit" role="main">
        <div class="panel panel-info">
            <div class="panel-heading">
                ...
                <g:hasErrors bean="${upDirectProcActualInstance}">
                    <ul class="errors" role="alert">
                        <g:eachError bean="${upDirectProcActualInstance}" var="error">
            ...
            <div class="panel-body">
                ...
                <g:form method="post" >
                    ...
                    <g:hiddenField name="version" value="${upDirectProcActualInstance?.version}" />
                    <fieldset class="form" id="upDirectProcActualForm" name="upDirectProcActualForm">
