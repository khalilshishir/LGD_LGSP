...
<body>
%{--<a href="#edit-auditFirm" class="skip" tabindex="-1"><g:message code="default.link.skip.label"--}%
...
<div id="edit-auditFirm" class="content scaffold-edit" role="main">
    <div class="panel panel-info">
        <div class="panel-heading">
            ...
            <g:hasErrors bean="${auditFirmInstance}">
                <ul class="errors" role="alert">
                    <g:eachError bean="${auditFirmInstance}" var="error">
        ...
        <div class="panel-body">
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${auditFirmInstance?.version}" />
                <fieldset class="form">
