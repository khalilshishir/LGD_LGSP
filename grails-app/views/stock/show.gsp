...
<html>
	<head>
        ...
        <g:set var="entityName" value="${message(code: 'default.stock.title')}" />
	...
	<body>
		...
		<div id="show-stock" class="content scaffold-show" role="main">
			...
			<ol class="property-list stock">
				...
				<g:if test="${stockInstance?.item}">
				<li class="fieldcontain">
					%{--<span id="item-label" class="property-label"><g:message code="stock.item.label" default="Item" /></span>--}%
                    <span id="item-label" class="property-label"><g:message code="default.stock.item" default="Item" /></span>

						<span class="property-value" aria-labelledby="item-label"><g:fieldValue bean="${stockInstance}" field="item"/></span>
