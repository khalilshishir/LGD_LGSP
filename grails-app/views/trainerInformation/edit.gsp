...
<html>
	...
	<body>
		...
		<div id="edit-trainerInformation" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${trainerInformationInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${trainerInformationInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${trainerInformationInstance?.version}" />
				<fieldset class="form">
