...
<html>
	...
	<body>
		%{--<a href="#create-upAssetRegister" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
		...
		<div id="create-upAssetRegister" class="content scaffold-create" role="main">
