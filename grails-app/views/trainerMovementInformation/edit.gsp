...
<html>
	...
	<body>
		...
		<div id="edit-trainerMovementInformation" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${trainerMovementInformationInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${trainerMovementInformationInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${trainerMovementInformationInstance?.version}" />
				<fieldset class="form">
