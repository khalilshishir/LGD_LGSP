...
<html>
	...
	<body>
		...
		<div id="edit-trainingOrientationRefresherTrainingPeerLearning" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${trainingOrientationRefresherTrainingPeerLearningInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${trainingOrientationRefresherTrainingPeerLearningInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${trainingOrientationRefresherTrainingPeerLearningInstance?.version}" />
				<fieldset class="form">
