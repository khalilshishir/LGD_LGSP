...
<html>
	...
	<body>
		%{--<a href="#edit-STAKEHOLDER" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
		...
		<div id="edit-STAKEHOLDER" class="content scaffold-edit" role="main">
			%{--<h1><g:message code="default.edit.label" args="[entityName]" /></h1>--}%
        <div class="panel panel-info">
            <div class="panel-heading">
                <h3 class="panel-title"><g:message code="Edit Stake Holder" args="[entityName]" /></h3>
                </div>
            ...
            <g:if test="${flash.message}">
                ...
                <div class="panel-body">
                    <g:form method="post" >
                        ...
                        <g:hiddenField name="version" value="${STAKEHOLDERInstance?.version}" />
                        <fieldset class="form">
