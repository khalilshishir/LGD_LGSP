...
<html>
	...
	<body>
	%{--	<a href="#edit-procurement_Type" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
    ...
    <p align="right" style="color:#666; font-size: 11px; padding-right: 5px; margin-top: 10px;">
		...
		<div id="edit-procurement_Type" class="content scaffold-edit" role="main">
            ...
            <div class="panel panel-info">
                <div class="panel-heading">
                    ...
                    <g:hasErrors bean="${procurement_TypeInstance}">
                        <ul class="errors" role="alert">
                            <g:eachError bean="${procurement_TypeInstance}" var="error">
            ...
            <div class="panel-body">
				...
				<g:hiddenField name="version" value="${procurement_TypeInstance?.version}" />
				<fieldset class="form">
