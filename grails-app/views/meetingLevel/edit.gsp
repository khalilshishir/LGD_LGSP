...
<html>
    ...
    <p align="right" style="color:#666; font-size: 11px; padding-right: 5px; margin-top: 10px;">
		...
		%{--<a href="#edit-meetingLevel" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
		%{--<div class="nav" role="navigation">--}%
			...
			%{--</ul>--}%
		%{--</div>--}%
		<div id="edit-meetingLevel" class="content scaffold-edit" role="main">
        <div class="panel panel-info">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${meetingLevelInstance?.version}" />
				<fieldset class="form">
