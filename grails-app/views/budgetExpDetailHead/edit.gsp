...
<body>
%{--<a href="#edit-budgetExpDetailHead" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
...
<div id="edit-budgetExpDetailHead" class="content scaffold-edit" role="main">
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${budgetExpDetailHeadInstance?.version}" />
                <fieldset class="form">
