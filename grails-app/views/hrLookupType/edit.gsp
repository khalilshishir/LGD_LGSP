...
<html>
    ...
    <div id="edit-hrLookupType" class="content scaffold-edit" role="main">
        <div class="panel panel-info">
            <div class="panel-heading">
                ...
                <g:hasErrors bean="${hrLookupTypeInstance}">
                    <ul class="errors" role="alert">
                        <g:eachError bean="${hrLookupTypeInstance}" var="error">
            ...
            <div class="panel-body">
                ...
                <g:form method="post" >
                    ...
                    <g:hiddenField name="version" value="${hrLookupTypeInstance?.version}" />
                    <fieldset class="form">
