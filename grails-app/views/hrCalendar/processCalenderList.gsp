...
<div id="wrapper">
    <h1>Hr Process Calender List</h1>
...
%{--Add Search option contents--}%
    <div id="search-div">
        <g:form id="search" name="search" action="processCalenderSearch">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="common-list-table">
        ...
        <g:each in="${hrCalendarInstanceList}" status="i" var="hrCalendarInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td class="list-align-center"><g:link action="processCalenderEdit" id="${hrCalendarInstance.id}">${hrCalendarInstance?.calendarYear}</g:link></td>
