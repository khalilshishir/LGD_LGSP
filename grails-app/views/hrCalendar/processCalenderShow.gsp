...
<div id="wrapper">
    <h1>Show Hr Process Calender</h1>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="common-list-table">
        ...
        <g:each in="${hrCalendarMonths}" var="l">
            <tr>
                ...
                <td class="list-align-center"><g:if test="${l?.salary.equals(true)}">Yes</g:if><g:else>No</g:else></td>
                <td class="list-align-center"><g:if test="${l?.increment.equals(true)}">Yes</g:if><g:else>No</g:else></td>
                <td class="list-align-center"><g:if test="${l?.bonus.equals(true)}">Yes</g:if><g:else>No</g:else></td>
            </tr>
        </g:each>
        </tbody>
    </table>
    ...
    <g:form>
        <fieldset class="buttons">
            <g:hiddenField name="id" value="${hrCalendarInstance?.id}" />
            <g:link class="edit" action="processCalenderEdit" id="${hrCalendarInstance?.id}">Edit</g:link>
            %{--<g:link class="edit" action="edit" id="${hrCalendarInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>--}%
            %{--<g:actionSubmit class="delete" action="delete" value="${message(code: 'default.button.delete.label', default: 'Delete')}" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');" />--}%
        </fieldset>
    </g:form>
