...
<html>
	...
	<body>
		%{--<a href="#edit-caseInformation" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
    ...
    <p align="right" style="color:#666; font-size: 11px; padding-right: 5px; margin-top: 10px;">
		...
		<div id="edit-caseInformation" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${caseInformationInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${caseInformationInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${caseInformationInstance?.version}" />
				<fieldset class="form">
