...
<html>
	...
	<body>
		%{--<a href="#edit-calendar_Month" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-calendar_Month" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${calendar_MonthInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${calendar_MonthInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${calendar_MonthInstance?.version}" />
				<fieldset class="form">
