...
<html>
	...
	<body>
		%{--<a href="#create-calendar_Month" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-calendar_Month" class="content scaffold-create" role="main">
