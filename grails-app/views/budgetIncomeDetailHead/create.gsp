...
<body>
%{--<a href="#create-budgetIncomeDetailHead" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
...
%{--</ul>--}%
%{--</div>--}%
%{--<div id="create-budgetIncomeDetailHead" class="content scaffold-create" role="main">--}%
