...
<body>
%{--<a href="#edit-budgetIncomeDetailHead" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
...
<div id="edit-budgetIncomeDetailHead" class="content scaffold-edit" role="main">
    <div class="panel panel-info">
        <div class="panel-heading">
            ...
            <g:hasErrors bean="${budgetIncomeDetailHeadInstance}">
                <ul class="errors" role="alert">
                    <g:eachError bean="${budgetIncomeDetailHeadInstance}" var="error">
        ...
        <div class="panel-body">
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${budgetIncomeDetailHeadInstance?.version}" />
                <fieldset class="form">
