...
<html>
	...
	<body>
		%{--<a href="#edit-upazila" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
        ...
        <div id="edit-upazila" class="content scaffold-edit" role="main">
            <div class="panel panel-info">
                <div class="panel-heading">
                    ...
                    <g:hasErrors bean="${upazilaInstance}">
                    <ul class="errors" role="alert">
                        <g:eachError bean="${upazilaInstance}" var="error">
                ...
                <div class="panel-body">
                    <g:form method="post" >
                        ...
                        <g:hiddenField name="version" value="${upazilaInstance?.version}" />
                        <fieldset class="form">
