...
<script type="text/javascript">
    ...
    function getServiceLength() {
       //debugger;
        ...
        var lengthOfService = v_yy+" Yrs,"+v_mm+" Months,"+noOfDays+" Days";
        //$("#serviceLength").val(lengthOfService);
        $("#serviceLengthYY").val(v_yy);
        $("#serviceLengthMM").val(v_mm);
        $("#serviceLengthDD").val(noOfDays);
        }
        else {
            var allMonths2 = currentDate.getMonth() - joinDate.getMonth() + (12 * (currentDate.getFullYear() - joinDate.getFullYear()));
            var v_yy2 =  Math.floor(allMonths2/12) - lwpYear;
            ...
            var lengthOfService2 = v_yy2+" Yrs,"+v_mm2+" Months,"+noOfDays2+" Days";
            //$("#serviceLength").val(lengthOfService2);
            $("#serviceLengthYY").val(v_yy2);
            $("#serviceLengthMM").val(v_mm2);
            $("#serviceLengthDD").val(noOfDays2);
        }
    }
...
<g:textField id="totalLeaveWithoutPayDays" name="totalLeaveWithoutPayDays" value="${totalLeaveWithoutPayDays}" style="text-align: center;"/>
