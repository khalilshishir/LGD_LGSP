...
<html>
	...
	<body>
		...
		<div id="edit-trainingType" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${trainingTypeInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${trainingTypeInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${trainingTypeInstance?.version}" />
				<fieldset class="form">
