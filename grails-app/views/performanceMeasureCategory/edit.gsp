...
<html>
	...
	<body>
		%{--<a href="#edit-performanceMeasureCategory" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
		...
		<div id="edit-performanceMeasureCategory" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${performanceMeasureCategoryInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${performanceMeasureCategoryInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${performanceMeasureCategoryInstance?.version}" />
				<fieldset class="form">
