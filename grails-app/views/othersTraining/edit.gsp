...
<html>
	...
	<body>
		...
		<div id="edit-othersTraining" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${othersTrainingInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${othersTrainingInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${othersTrainingInstance?.version}" />
				<fieldset class="form">
